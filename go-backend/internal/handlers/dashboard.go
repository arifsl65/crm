...
func (h *DashboardHandler) GetStats(c *gin.Context) {
	...
	err := tenantDB.Query(c, `
		SELECT al.id, al.action, al.entity_type, al.entity_id, COALESCE(u.first_name || ' ' || u.last_name, u.first_name, u.last_name, ''), al.created_at
		FROM audit_logs al
...
func (h *DashboardHandler) GetClientWorkload(c *gin.Context) {
	...
	err := tenantDB.Query(c, `
		SELECT u.id, COALESCE(u.first_name || ' ' || u.last_name, u.first_name, u.last_name, ''),
		...
		GROUP BY u.id, COALESCE(u.first_name || ' ' || u.last_name, u.first_name, u.last_name, '')
